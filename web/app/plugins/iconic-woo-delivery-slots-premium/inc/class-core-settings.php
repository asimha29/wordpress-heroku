		...
		<div class="iconic-settings-sidebar">
			...
			<?php if ( $show_bundle ) { ?>
				<div class="iconic-settings-bundle iconic-settings-sidebar__widget iconic-settings-sidebar__widget--bundle">
					...
					<p class="iconic-settings-bundle__secondary-link">or <a href="https://iconicwp.com/bundles/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=jckwds&utm_content=bundles-cta" target="_blank">view bundles</a></p>
