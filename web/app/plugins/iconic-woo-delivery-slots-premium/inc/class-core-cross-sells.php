	...
	private static function get_plugins() {
		return array(
			...
			'iconic-woo-sales-booster'                => array(
				...
				'description' => __( 'Use proven cross-selling techniques to increase the average order value of your store.', 'jckwds' ),
			...
			'flux-checkout'                           => array(
				...
				'description' => __( 'Prevent abandoned carts with a slick multi-step checkout experience, designed for your customer’s device.', 'jckwds' ),
